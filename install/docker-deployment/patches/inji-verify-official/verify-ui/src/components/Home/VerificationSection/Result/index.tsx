...
const Result = () => {
  const { vc, vcStatus, offline, verificationLevel, message } = useVerificationFlowSelector((state) => state.verificationResult ?? { vc: null, vcStatus: null, offline: false, verificationLevel: undefined, message: undefined });
