...
interface VerificationResult {
  ...
  /**
   * Whether this verification was done offline.
   */
  offline?: boolean;

  /**
   * Level of verification assurance (for offline verification).
   * - CRYPTOGRAPHIC: Full signature verification
   * - TRUSTED_ISSUER: Issuer is cached/trusted but crypto verification failed
   */
...
export type VcStatus = "SUCCESS" | "INVALID" | "EXPIRED" | "UNKNOWN_ISSUER" | "ERROR";
